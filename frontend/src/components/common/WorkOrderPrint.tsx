...
export const WorkOrderPrint: React.FC<WorkOrderPrintProps> = ({
    ...
    // Filter references (decision '03' = 참조/통보)
            ...
            <div className="p-[10mm] max-w-[800px] mx-auto font-sans">
                ...
                <div className="flex justify-between items-start mb-6 w-full">
                    ...
                    <div className="space-y-1 text-sm pt-2 flex-1 min-w-0 mr-4">
                        <div className="flex"><span className="font-bold w-20 shrink-0">지시번호:</span><span className="truncate">{id}</span></div>
                        <div className="flex"><span className="font-bold w-20 shrink-0">작업명:</span><span className="truncate">{name}</span></div>
                ...
                <div className="grid grid-cols-4 gap-4 border-t border-b border-black py-2 mb-6 text-xs text-center border-collapse">
                    ...
                    <div className="flex justify-center gap-2"><span className="font-bold">작업일자:</span><span>{formatDateTime(date)}</span></div>
                ...
                {note && (
                    <div className="mb-6 break-inside-avoid">
                        <div className="font-bold mb-1 text-sm">비고 / 특이사항:</div>
